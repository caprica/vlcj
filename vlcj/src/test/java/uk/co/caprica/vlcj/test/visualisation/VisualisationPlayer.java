 ...
 * <p>
 * When running the application, choose a visualisation type, change the effect
 * width/height if you want, and hit "Play".
 */
public class VisualisationPlayer extends VlcjTest {
  ...
  private void doPlay() {
    String[] options = {
      "audio-visual=visual",
      "effect-list=" + comboBox.getSelectedItem(),
      "effect-width=" + widthTextField.getText(),
      "effect-height=" + heightTextField.getText()
    };
