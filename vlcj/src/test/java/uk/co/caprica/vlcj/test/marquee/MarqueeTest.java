 ...
 * Test the marquee.
 * <p>
 * The enable/disable buttons simply toggle the marquee on/off, to actually
 * change marquee settings you must use the apply button.
 */
    ...
    private ControlsPanel() {
      ...
      applyButton.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent evt) {
          ...
          marquee().text(textTextField.getText())
                   .location(x, y)
