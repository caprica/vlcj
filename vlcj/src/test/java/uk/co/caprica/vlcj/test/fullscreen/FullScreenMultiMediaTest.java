 ...
 * <p>
 * Each media file should appear in the full-screen window, no native windows
 * should be created.
 * <p>
 * Specify a directory containing media files on the command-line, and use the
 * space key to start playing the next file.
 * <p>
 * This test searches for ".iso" media files, change the {@link #VIDEO_FILE_FILTER}
 * to search for other media file types.
 */
