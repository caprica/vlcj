...
import uk.co.caprica.vlcj.player.direct.DirectRenderCallbackAdapter;
 ...
 */
public class FasterDirectTestPlayer extends VlcjTest {
    ...
    public FasterDirectTestPlayer(String media, String[] args) throws InterruptedException, InvocationTargetException {
    ...
    public static void main(String[] args) throws InterruptedException, InvocationTargetException {
        ...
        new FasterDirectTestPlayer(args[0], vlcArgs);
