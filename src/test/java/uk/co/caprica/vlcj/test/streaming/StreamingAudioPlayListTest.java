 ...
 * <p>
 * A directory is scanned recursively for mp3 files to create a play-list. This
 * play-list is then randomised before being played through a media list player.
 * <p>
 * Since a multicast streaming protocol is used, you can have any number of
 * concurrent clients. You can use any client you want, whether it is vlc 
 * itself, another client built using vlcj or any other client that can receive
 * and play audio over RTP.  
 * <p>
 * You specify three arguments on the command-line when starting this 
 * application:
 * <ul>
