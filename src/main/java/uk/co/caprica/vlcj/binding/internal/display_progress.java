 ...
 *
 */
public interface display_progress extends Callback {
     ...
     */
    void display_progress(Pointer p_data, Pointer p_id, String psz_title, String psz_text, int b_indeterminate, float f_position, String psz_cancel);
}
