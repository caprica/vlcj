...
public final class MediaPlayerEventFactory {
     ...
     */
    public static MediaPlayerEvent createEvent(LibVlc libvlc, libvlc_instance_t libvlcInstance, MediaPlayer mediaPlayer, libvlc_event_t event) {
        switch(libvlc_event_e.event(event.type)) {
            case libvlc_MediaPlayerMediaChanged    : return new MediaPlayerMediaChangedEvent    (libvlc, libvlcInstance, mediaPlayer, event);
