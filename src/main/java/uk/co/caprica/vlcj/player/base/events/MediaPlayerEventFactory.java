...
public final class MediaPlayerEventFactory {
     ...
     */
    public static MediaPlayerEvent createEvent(MediaPlayer mediaPlayer, libvlc_event_t event) {
        switch(libvlc_event_e.event(event.type)) {
            case libvlc_MediaPlayerMediaChanged    : return new MediaPlayerMediaChangedEvent    (mediaPlayer, event);
