...
public enum MediaPlayerEventType {
    ...
    MEDIA_PLAYER_READY             (0x0000000000400000L),

    MEDIA_META_CHANGED             (0x0000000000800000L),
    MEDIA_SUB_ITEM_ADDED           (0x0000000001000000L),
    MEDIA_DURATION_CHANGED         (0x0000000002000000L),
    MEDIA_PARSED_CHANGED           (0x0000000004000000L),
    MEDIA_PARSED_STATUS            (0x0000000008000000L),
    MEDIA_FREED                    (0x0000000010000000L),
    MEDIA_STATE_CHANGED            (0x0000000020000000L),
    MEDIA_SUB_ITEM_TREE_ADDED      (0x0000000040000000L),

    MEDIA_PLAYER_CORKED            (0x0000000080000000L),
    MEDIA_PLAYER_MUTED             (0x0000000100000000L),
    MEDIA_PLAYER_AUDIO_VOLUME      (0x0000000200000000L),
    MEDIA_PLAYER_AUDIO_DEVICE      (0x0000000400000000L),

    MEDIA_PLAYER_CHAPTER_CHANGED   (0x0000000800000000L),

    NEW_MEDIA                      (0x0000001000000000L),
    SUB_ITEM_PLAYED                (0x0000002000000000L),
    SUB_ITEM_FINISHED              (0x0000004000000000L),
    END_OF_SUB_ITEMS               (0x0000008000000000L),
