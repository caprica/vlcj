 ...
 * <p>
 * Be very careful with {@link #purge()} since it will delete recursively the
...
public class NativeLibraryManager {
  ...
  /**
   * Top level directory name within the package archive containing the 
   * resources to unpack.
   * <p>
   ...
   * contents of the native library installation directory.</strong>
   * 
